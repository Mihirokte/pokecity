      ...
      <meshBasicMaterial side={THREE.BackSide}>
        <primitive
          ...
          object={(() => {
            ...
            gradient.addColorStop(0, '#0ea5e9'); // Deep azure at top
            gradient.addColorStop(0.4, '#7dd3fc'); // Light blue
            gradient.addColorStop(0.7, '#bae6fd'); // Light cyan at horizon
            gradient.addColorStop(1, '#fcd34d'); // Golden near ground
